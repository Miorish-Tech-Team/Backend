...
AppliedCoupon.belongsTo(User, { foreignKey: "userId", as: "user" });
AppliedCoupon.belongsTo(Coupon, { foreignKey: "couponId", as: "coupon" });
AppliedCoupon.belongsTo(Product, { foreignKey: "productId", as: "product" });

User.hasMany(AppliedCoupon, { foreignKey: "userId", as: "appliedCoupons" });
Coupon.hasMany(AppliedCoupon, { foreignKey: "couponId", as: "appliedCoupons" });
Product.hasMany(AppliedCoupon, { foreignKey: "productId", as: "appliedCoupons" });
...
// Seller ↔ User
User.hasOne(Seller, { foreignKey: "userId", as: "seller", onDelete: "CASCADE" });
Seller.belongsTo(User, { foreignKey: "userId", as: "user", onDelete: "CASCADE" });
...
// User ↔ DeliveryEstimate
User.hasOne(DeliveryEstimate, { foreignKey: "userId", onDelete: "CASCADE" });
DeliveryEstimate.belongsTo(User, { foreignKey: "userId", onDelete: "CASCADE" });
...
AccountDeletionRequest.belongsTo(Seller, { foreignKey: 'sellerId', as: 'seller' });

User.hasMany(AccountDeletionRequest, { foreignKey: 'userId', as: 'deletionRequests' });
Seller.hasMany(AccountDeletionRequest, { foreignKey: 'sellerId', as: 'deletionRequests' });
